      ...
      <div className="bg-green-600 rounded-lg text-white py-16 sm:py-24">
        <div className="flex flex-col items-center gap-4 sm:gap-6 w-[90%] md:w-4/5 lg:w-1/2 text-center mx-auto">
          ...
          <p className="leading-loose font-[500]">
            Enjoy a thoughtfully crafted design that promotes easy navigation and efficiency. Each layer is strategically organized to enhance user experience and streamline workflows.
          </p>
          ...
          {message && <p className="mt-4 text-lg text-green-200">{message}</p>}
        </div>
      </div>
    </section>
  );
